<template>
  <div>
    ...
    <group>
      <cell :title="item.account" v-for="(item,index) in dataList" :key="index" :link="'/member/userinfo/'+item.id" :inline-desc="item.name+' 余额:'+item.balance+'元'" class="font-size-normal"></cell>
    </group>
