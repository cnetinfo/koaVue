<template>
  <div>
    ...
    <group>
      <cell class="font-size-normal" :title="item.operator+' '+ item.dateTime" v-for="(item,index) in dataList" :key="item.id"  :inline-desc="item.content"></cell>
    </group>
